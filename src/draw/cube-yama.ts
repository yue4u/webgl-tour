...
export default function draw(id: string) {
  ...
  const shaderProgram = gl.utils.useProgram(vs, fs);
  ...
  const texture = gl.utils.texture(require("../images/yama.jpg"));
  ...
  function drawScene(
    ...
    gl.clearColor(255 / 256, 105 / 256, 180 / 256, 1.0); // Clear to black, fully opaque
